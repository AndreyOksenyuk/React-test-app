      ...
      <div>
         <form onSubmit={props.handleSubmit} className='login-form'>
            <div className="flex-row">
               ...
               <Field id='email' className='lf--input' type="email" placeholder='email:' name='email' component='input' />
            </div>
            <div className="flex-row">
               ...
               <Field id='password' className='lf--input' type="password" placeholder='password' name='password' component='input' />
            </div>
